...
def banner():
	...
	print("+" + "-" * 63 + "+")
	print("|" + " " * 63 + "|")
	print("|" + " " * 15 + ">>> Python-Викторина ver.0.0.0.1 <<<" + " " * 12 + "|")
